        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">Requêtes en attente</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="#!">Requêtes en attente</a></li>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5> Liste des requêtes en attente</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                <span>
                                    <b>Vous n'avez aucune reclamation en cours! </b> </span>
                            </div>
                    </div>
                </div>
