            ...
            <div class="card-body">
                <div class="row align-items-center m-l-0">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ route('admin.operators.create') }}" class="btn btn-primary btn-sm mb-3 btn-round"> <i class="fa fa-plus"></i>
                            Ajouter Opérateur
                        </a>
                    </div>
                </div>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.operators.edit', $institution->id) }}" class="btn btn-primary btn-sm">Editer</a>
                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirm" onclick="deleteData({{ $institution->id}})" data-original-title="Supprimer">Supprimer</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p>Voulez-vous supprimer cet opérateur?</p>
...
<script>
    ...
    {
        var id = id;
        var url = '{{ route("admin.operators.destroy", ":id") }}';
